...
const OrderFullDetail = ({ id }) => {
    ...
    if (!orderData || !orderData.data || orderData.data.length < 2) {
        return <div className="order-detail-error">Order information not available</div>;
    }
    
    const products = orderData.data[0] || [];
    const order = orderData.data[1] || {};
                                ...
                                <div className="product-details">
                                    ...
                                    <div className="product-info">
                                        ...
                                        <div className="product-info-item">
                                            ...
                                            <span className="info-value">{product.discount_percent}%</span>
                                        </div>
                                        <div className="product-info-item">
                                            <span className="info-label">Stock:</span>
                                            <span className="info-value">{product.stock_quantity}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="product-specs">
                                        <div className="spec-item">
                                            ...
                                            <span className="spec-value">{product.clay_type}</span>
                                        </div>
                                        <div className="spec-item">
                                            <span className="spec-label">Firing:</span>
                                            <span className="spec-value">{product.firing_method}</span>
                                        </div>
                                        <div className="spec-item">
                                            <span className="spec-label">Glaze:</span>
                                            <span className="spec-value">{product.glaze_type}</span>
                                        </div>
                                        <div className="spec-item">
                                    ...
                                    <div className="product-tags">
                                        {product.is_fragile && <span className="tag fragile">Fragile</span>}
                                        {product.is_handmade && <span className="tag handmade">Handmade</span>}
                                    </div>
                                </div>
                            </div>
                        ))}
